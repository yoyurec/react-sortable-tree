 ...
 */
    ...
    function(module, exports, __webpack_require__) {
        ...
        var treeIdCounter = 1, mergeTheme = function(props) {
            ...
            return _inherits(ReactSortableTree, _Component), _createClass(ReactSortableTree, [ {
                ...
                value: function(_ref5) {
                    var _this3 = this, draggedNode = _ref5.node, draggedDepth = _ref5.depth, draggedMinimumTreeIndex = _ref5.minimumTreeIndex;
                    ...
                    if (this.state.draggedDepth !== draggedDepth || this.state.draggedMinimumTreeIndex !== draggedMinimumTreeIndex) {
                        ...
                        this.setState({
                            ...
                            return _this3.props.onDragHover();
                        });
                    }
                }
            }, {
        ...
        ReactSortableTree.propTypes = {
            ...
            dragPastCentre: _propTypes2.default.bool,
            ...
            onDragHover: _propTypes2.default.func,
                ...
                value: function(el) {
                    ...
                    var _this2 = this, nodeDropTarget = {
                        ...
                        hover: function(dropTargetProps, monitor, component) {
                            var targetDepth = _this2.getTargetDepth(dropTargetProps, monitor, component), draggedNode = monitor.getItem().node, dragIndex = monitor.getItem().treeIndex, hoverIndex = dropTargetProps.treeIndex;
                            if (dropTargetProps.node !== draggedNode || targetDepth === dropTargetProps.path.length - 1) {
                                if (dropTargetProps.node === draggedNode || dragIndex === hoverIndex) return;
                                if (!0 === _this2.dragPastCentre) {
                                    var hoverRect = (0, _reactDom.findDOMNode)(component).getBoundingClientRect(), hoverMiddleY = (hoverRect.bottom - hoverRect.top) / 2, clientOffset = monitor.getClientOffset(), hoverClientY = clientOffset.y - hoverRect.top;
                            ...
                            _this2.dragHover({
                                ...
                                minimumTreeIndex: dropTargetProps.listIndex,
                                depth: targetDepth
                            }), monitor.getItem().treeIndex = hoverIndex;
                        },
