    ...
    function(module, exports, __webpack_require__) {
        ...
        var _treeNode = __webpack_require__(15), _treeNode2 = _interopRequireDefault(_treeNode), _nodeRendererDefault = __webpack_require__(18), _nodeRendererDefault2 = _interopRequireDefault(_nodeRendererDefault), _treePlaceholder = __webpack_require__(22), _treePlaceholder2 = _interopRequireDefault(_treePlaceholder), _placeholderRendererDefault = __webpack_require__(23), _placeholderRendererDefault2 = _interopRequireDefault(_placeholderRendererDefault), _treeDataUtils = __webpack_require__(0), _memoizedTreeDataUtils = __webpack_require__(6), _genericUtils = __webpack_require__(26), _defaultHandlers = __webpack_require__(5), _dndManager = __webpack_require__(27), _dndManager2 = _interopRequireDefault(_dndManager), _reactSortableTree = __webpack_require__(31), _reactSortableTree2 = _interopRequireDefault(_reactSortableTree), treeIdCounter = 1, mergeTheme = function(props) {
            ...
            function ReactSortableTree(props) {
                ...
                _this.handleResize = _this.handleResize.bind(_this), _this.drop = _this.drop.bind(_this), 
                _this.handleDndMonitorChange = _this.handleDndMonitorChange.bind(_this), props.isDynamicHeight && (_this.cellMeasurerCache = new _reactVirtualized.CellMeasurerCache({
                    fixedWidth: !0
                })), _this;
            }
            return _inherits(ReactSortableTree, _Component), _createClass(ReactSortableTree, [ {
                ...
                value: function() {
                    this.clearMonitorSubscription(), this.cellMeasurerCache && this.cellMeasurerCache.clearAll();
                }
            }, {
                key: "getRows",
                ...
                key: "handleResize",
                value: function() {
                    this.props.isDynamicHeight && this.list && (this.cellMeasurerCache.clearAll(), this.list.wrappedInstance.recomputeRowHeights());
                }
            }, {
                ...
                value: function(_ref) {
                    ...
                    this.props.onChange(treeData), this.handleResize(), this.props.onVisibilityToggle({
                        treeData: treeData,
                        node: targetNode,
                ...
                value: function(_ref3) {
                    ...
                    this.props.onChange(treeData), this.handleResize(), this.props.onMoveNode({
                        treeData: treeData,
                        node: node,
                        treeIndex: treeIndex,
                        path: path,
                ...
                value: function(_ref5) {
                    ...
                    if (this.state.draggedDepth !== draggedDepth || this.state.draggedMinimumTreeIndex !== draggedMinimumTreeIndex) {
                        ...
                        this.cellMeasurerCache && this.cellMeasurerCache.clearAll(), this.setState({
                            draggedNode: draggedNode,
                ...
                value: function(_ref10, _ref11) {
                    var _this5 = this, node = _ref10.node, parentNode = _ref10.parentNode, path = _ref10.path, lowerSiblingCounts = _ref10.lowerSiblingCounts, treeIndex = _ref10.treeIndex, listIndex = _ref11.listIndex, style = _ref11.style, getPrevRow = _ref11.getPrevRow, matchKeys = _ref11.matchKeys, swapFrom = _ref11.swapFrom, swapDepth = _ref11.swapDepth, swapLength = _ref11.swapLength, parent = _ref11.parent, _mergeTheme2 = mergeTheme(this.props), canDrag = _mergeTheme2.canDrag, generateNodeProps = _mergeTheme2.generateNodeProps, scaffoldBlockPxWidth = _mergeTheme2.scaffoldBlockPxWidth, searchFocusOffset = _mergeTheme2.searchFocusOffset, TreeNodeRenderer = this.treeNodeRenderer, NodeContentRenderer = this.nodeContentRenderer, nodeKey = path[path.length - 1], isSearchMatch = nodeKey in matchKeys, isSearchFocus = isSearchMatch && matchKeys[nodeKey] === searchFocusOffset, callbackParams = {
                        node: node,
                        parentNode: parentNode,
                        path: path,
                        lowerSiblingCounts: lowerSiblingCounts,
                    ...
                    return this.props.isDynamicHeight && (nodeProps.cache = this.cellMeasurerCache, 
                    nodeProps.parent = parent, nodeProps.rowIndex = listIndex), _react2.default.createElement(TreeNodeRenderer, _extends({
                        style: style,
                        key: nodeKey,
                        listIndex: listIndex,
                        ...
                        onHeightChange: function() {
                            return _this5.cellMeasurerCache && _this5.cellMeasurerCache.clear(treeIndex, 0);
                        }
                ...
                value: function() {
                    ...
                    if (rows.length < 1) {
                        ...
                        var ScrollZoneVirtualList = this.scrollZoneVirtualList, virtualizedRowHeight = void 0;
                        virtualizedRowHeight = this.props.isDynamicHeight ? this.cellMeasurerCache.rowHeight : "function" != typeof rowHeight ? rowHeight : function(_ref13) {
                        ...
                        list = _react2.default.createElement(_reactVirtualized.AutoSizer, {
                            ...
                            return _react2.default.createElement(ScrollZoneVirtualList, _extends({}, scrollToInfo, {
                                ...
                                deferredMeasurementCache: _this6.cellMeasurerCache,
                                rowRenderer: function(_ref16) {
                                    var index = _ref16.index, rowStyle = _ref16.style, parent = _ref16.parent;
        ...
        ReactSortableTree.propTypes = {
            ...
            isDynamicHeight: _propTypes2.default.bool,
